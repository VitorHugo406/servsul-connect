...
export function AppearancePersonalizationDialog({ open, onOpenChange }: { open: boolean; onOpenChange: (open: boolean) => void }) {
  ...
  const applyPreset = (preset: ThemePreset) => {
    ...
    toast.success(`Visual ${preset.name.toLowerCase()} aplicado.`);
  };
